...
help:
	@echo 'Management commands for DSiSc/crypto-suite:'
	@echo
	@echo 'Usage:'
...
build:
	@echo "building crypto-suite ${VERSION}"
	@echo "GOPATH=${GOPATH}"
	go build -v -ldflags "-X github.com/DSiSc/crypto-suite/version.GitCommit=${GIT_COMMIT}${GIT_DIRTY} -X github.com/DSiSc/crypto-suite/version.BuildDate=${BUILD_DATE}" ./...
